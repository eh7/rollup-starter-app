...
console.log(Object.keys(libp2p.peerId))

/*
const addr = process.argv[2]

const dial = async (_addr) => {
  const ma = multiaddr(_addr)
...
console.log('Multiaddrs', libp2p)
//const my_multiaddr = libp2p.peerInfo.multiaddrs.toString();
*/
